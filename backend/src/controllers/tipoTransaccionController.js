...
exports.create = async (req, res) => {
  try {
    const { empresaId } = req.query;
    const { TipoTransId, Descripcion, Tipo, ISR, AFP, ARS, Excento, Dependiente } = req.body;
    ...
    await pool.request()
      ...
      .query(`
        INSERT INTO NMTIPOSTRANSACCIONES (
          TipoTransId, EmpresaId, Descripcion, Tipo, ISR, AFP, ARS, Excento, Dependiente,
...
exports.update = async (req, res) => {
  try {
    ...
    const { empresaId } = req.query;
    const { Descripcion, Tipo, ISR, AFP, ARS, Excento, Dependiente } = req.body;
