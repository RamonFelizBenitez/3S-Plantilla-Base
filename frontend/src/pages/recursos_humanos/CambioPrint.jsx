...
import './DesignacionPrint.css'; // Reusing the same CSS
    ...
    const fetchPrintData = async () => {
      try {
        ...
        const [resPrint, resTa, resParam, resCargos, resEmpresa] = await Promise.all([
          axios.get(`/api/cambios/${id}/print`),
          axios.get('/api/configuracion/tipos-acciones?empresaId=1').catch(() => ({ data: [] })),
        ...
        if (Array.isArray(resTa.data)) {
          // Filtrar tipos de acciones para Cambios (normalmente los que NO son Designacion)
    ...
    <div className="print-container">
      ...
      <div className="print-row" style={{ flexDirection: 'column', flex: 1 }}>
        <div className="print-cell" style={{ borderRight: 'none' }}>
          <label style={{ fontSize: '13px' }}>10. CAMBIOS</label>
